(define (problem puzznic-17)
(:domain puzznic)
(:objects block0 - immovable-block block1 - immovable-block block2 - immovable-block block3 - immovable-block block4 - immovable-block block5 - immovable-block block6 - immovable-block block7 - immovable-block block8 - immovable-block block9 - immovable-block block10 - immovable-block block11 - movable-block block12 - immovable-block block13 - immovable-block block14 - immovable-block block15 - immovable-block block16 - matching-block block17 - matching-block block18 - matching-block block19 - immovable-block block20 - immovable-block block21 - movable-block block22 - matching-block block23 - matching-block block24 - matching-block block25 - movable-block block26 - immovable-block block27 - matching-block block28 - matching-block block29 - immovable-block block30 - immovable-block block31 - movable-block block32 - matching-block block33 - matching-block block34 - matching-block block35 - matching-block block36 - matching-block block37 - matching-block block38 - immovable-block block39 - immovable-block block40 - immovable-block block41 - movable-block block42 - immovable-block block43 - immovable-block block44 - immovable-block block45 - immovable-block block46 - immovable-block block47 - immovable-block block48 - movable-block block49 - immovable-block block50 - immovable-block block51 - movable-block block52 - matching-block block53 - matching-block block54 - movable-block block55 - matching-block block56 - movable-block block57 - matching-block block58 - movable-block block59 - immovable-block block60 - immovable-block block61 - movable-block block62 - immovable-block block63 - immovable-block block64 - immovable-block block65 - matching-block block66 - movable-block block67 - immovable-block block68 - movable-block block69 - immovable-block block70 - immovable-block block71 - movable-block block72 - movable-block block73 - matching-block block74 - matching-block block75 - immovable-block block76 - matching-block block77 - immovable-block block78 - movable-block block79 - immovable-block block80 - immovable-block block81 - movable-block block82 - immovable-block block83 - immovable-block block84 - immovable-block block85 - immovable-block block86 - immovable-block block87 - immovable-block block88 - immovable-block block89 - movable-block block90 - immovable-block block91 - movable-block block92 - movable-block block93 - matching-block block94 - matching-block block95 - immovable-block block96 - movable-block block97 - movable-block block98 - movable-block block99 - movable-block block100 - immovable-block block101 - matching-block block102 - immovable-block block103 - immovable-block block104 - immovable-block block105 - movable-block block106 - movable-block block107 - movable-block block108 - movable-block block109 - movable-block block110 - immovable-block block111 - immovable-block block112 - movable-block block113 - movable-block block114 - movable-block block115 - movable-block block116 - movable-block block117 - movable-block block118 - movable-block block119 - movable-block)
(:init
	(is-immovable block0)
	(right block0 block1)
	(down block0 block10)
	...
	(same-color block17 block28)
	(same-color block17 block33)
	(same-color block17 block73)
	(same-color block17 block93)
	(same-color block17 block101)
	(same-color block28 block17)
	(same-color block28 block33)
	(same-color block28 block73)
	(same-color block28 block93)
	(same-color block28 block101)
	(same-color block33 block17)
	(same-color block33 block28)
	(same-color block33 block73)
	(same-color block33 block93)
	(same-color block33 block101)
	(same-color block73 block17)
	(same-color block73 block28)
	(same-color block73 block33)
	(same-color block73 block93)
	(same-color block73 block101)
	(same-color block93 block17)
	(same-color block93 block28)
	(same-color block93 block33)
	(same-color block93 block73)
	(same-color block93 block101)
	(same-color block101 block17)
	(same-color block101 block28)
	(same-color block101 block33)
	(same-color block101 block73)
	(same-color block101 block93)
	(same-color block22 block34)
	(same-color block22 block53)
	(same-color block22 block57)
	(same-color block22 block65)
	(same-color block22 block76)
	(same-color block22 block94)
	(same-color block34 block22)
	(same-color block34 block53)
	(same-color block34 block57)
	(same-color block34 block65)
	(same-color block34 block76)
	(same-color block34 block94)
	(same-color block53 block22)
	(same-color block53 block34)
	(same-color block53 block57)
	(same-color block53 block65)
	(same-color block53 block76)
	(same-color block53 block94)
	(same-color block57 block22)
	(same-color block57 block34)
	(same-color block57 block53)
	(same-color block57 block65)
	(same-color block57 block76)
	(same-color block57 block94)
	(same-color block65 block22)
	(same-color block65 block34)
	(same-color block65 block53)
	(same-color block65 block57)
	(same-color block65 block76)
	(same-color block65 block94)
	(same-color block76 block22)
	(same-color block76 block34)
	(same-color block76 block53)
	(same-color block76 block57)
	(same-color block76 block65)
	(same-color block76 block94)
	(same-color block94 block22)
	(same-color block94 block34)
	(same-color block94 block53)
	(same-color block94 block57)
	(same-color block94 block65)
	(same-color block94 block76)
	(same-color block23 block74)
	(same-color block74 block23)
	(same-color block32 block52)
	(same-color block52 block32)
	(same-color block37 block55)
	(same-color block55 block37)
	(same-color block16 block18)
	(same-color block16 block27)
	(same-color block16 block36)
	(same-color block18 block16)
	(same-color block18 block27)
	(same-color block18 block36)
	(same-color block27 block16)
	(same-color block27 block18)
	(same-color block27 block36)
	(same-color block36 block16)
	(same-color block36 block18)
	(same-color block36 block27)
	(same-color block24 block35)
	(same-color block35 block24)
	(= (num-steps) 0)
)
(:goal (and
	(is-empty block17)
