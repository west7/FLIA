(define (problem puzznic-14)
(:domain puzznic)
(:objects block0 - immovable-block block1 - immovable-block block2 - immovable-block block3 - immovable-block block4 - immovable-block block5 - immovable-block block6 - immovable-block block7 - immovable-block block8 - immovable-block block9 - immovable-block block10 - immovable-block block11 - movable-block block12 - movable-block block13 - movable-block block14 - movable-block block15 - movable-block block16 - movable-block block17 - movable-block block18 - movable-block block19 - immovable-block block20 - immovable-block block21 - movable-block block22 - movable-block block23 - matching-block block24 - matching-block block25 - matching-block block26 - movable-block block27 - movable-block block28 - movable-block block29 - immovable-block block30 - immovable-block block31 - movable-block block32 - movable-block block33 - matching-block block34 - immovable-block block35 - matching-block block36 - movable-block block37 - movable-block block38 - movable-block block39 - immovable-block block40 - immovable-block block41 - movable-block block42 - movable-block block43 - immovable-block block44 - immovable-block block45 - immovable-block block46 - movable-block block47 - movable-block block48 - movable-block block49 - immovable-block block50 - immovable-block block51 - matching-block block52 - movable-block block53 - matching-block block54 - movable-block block55 - movable-block block56 - matching-block block57 - matching-block block58 - matching-block block59 - immovable-block block60 - immovable-block block61 - matching-block block62 - immovable-block block63 - matching-block block64 - movable-block block65 - movable-block block66 - matching-block block67 - immovable-block block68 - matching-block block69 - immovable-block block70 - immovable-block block71 - immovable-block block72 - immovable-block block73 - immovable-block block74 - movable-block block75 - movable-block block76 - immovable-block block77 - immovable-block block78 - immovable-block block79 - immovable-block block80 - immovable-block block81 - movable-block block82 - movable-block block83 - movable-block block84 - matching-block block85 - matching-block block86 - matching-block block87 - movable-block block88 - movable-block block89 - immovable-block block90 - immovable-block block91 - movable-block block92 - movable-block block93 - movable-block block94 - matching-block block95 - immovable-block block96 - matching-block block97 - movable-block block98 - movable-block block99 - immovable-block block100 - immovable-block block101 - movable-block block102 - movable-block block103 - movable-block block104 - immovable-block block105 - immovable-block block106 - immovable-block block107 - movable-block block108 - movable-block block109 - immovable-block block110 - immovable-block block111 - immovable-block block112 - immovable-block block113 - immovable-block block114 - immovable-block block115 - immovable-block block116 - immovable-block block117 - immovable-block block118 - immovable-block block119 - immovable-block)
(:init
	(is-immovable block0)
	(right block0 block1)
	(down block0 block10)
	...
	(same-color block35 block84)
	(same-color block35 block86)
	(same-color block84 block35)
	(same-color block84 block86)
	(same-color block86 block35)
	(same-color block86 block84)
	(same-color block23 block61)
	(same-color block61 block23)
	(same-color block33 block57)
	(same-color block33 block63)
	(same-color block33 block68)
	(same-color block57 block33)
	(same-color block57 block63)
	(same-color block57 block68)
	(same-color block63 block33)
	(same-color block63 block57)
	(same-color block63 block68)
	(same-color block68 block33)
	(same-color block68 block57)
	(same-color block68 block63)
	(same-color block53 block94)
	(same-color block94 block53)
	(same-color block66 block96)
	(same-color block96 block66)
	(same-color block25 block56)
	(same-color block25 block58)
	(same-color block25 block85)
	(same-color block56 block25)
	(same-color block56 block58)
	(same-color block56 block85)
	(same-color block58 block25)
	(same-color block58 block56)
	(same-color block58 block85)
	(same-color block85 block25)
	(same-color block85 block56)
	(same-color block85 block58)
	(= (num-steps) 0)
)
(:goal (and
	(is-empty block24)
