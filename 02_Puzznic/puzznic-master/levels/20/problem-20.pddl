(define (problem puzznic-20)
(:domain puzznic)
(:objects block0 - immovable-block block1 - immovable-block block2 - immovable-block block3 - immovable-block block4 - immovable-block block5 - immovable-block block6 - immovable-block block7 - immovable-block block8 - immovable-block block9 - immovable-block block10 - immovable-block block11 - movable-block block12 - matching-block block13 - movable-block block14 - matching-block block15 - matching-block block16 - movable-block block17 - immovable-block block18 - movable-block block19 - immovable-block block20 - immovable-block block21 - movable-block block22 - matching-block block23 - movable-block block24 - matching-block block25 - matching-block block26 - movable-block block27 - movable-block block28 - movable-block block29 - immovable-block block30 - immovable-block block31 - movable-block block32 - matching-block block33 - matching-block block34 - matching-block block35 - matching-block block36 - matching-block block37 - matching-block block38 - movable-block block39 - immovable-block block40 - immovable-block block41 - movable-block block42 - matching-block block43 - matching-block block44 - matching-block block45 - matching-block block46 - matching-block block47 - matching-block block48 - movable-block block49 - immovable-block block50 - immovable-block block51 - immovable-block block52 - immovable-block block53 - immovable-block block54 - immovable-block block55 - immovable-block block56 - immovable-block block57 - immovable-block block58 - immovable-block block59 - immovable-block)
(:init
	(is-immovable block0)
	(right block0 block1)
	(down block0 block10)
	...
	(same-color block22 block25)
	(same-color block22 block34)
	(same-color block22 block42)
	(same-color block22 block45)
	(same-color block25 block22)
	(same-color block25 block34)
	(same-color block25 block42)
	(same-color block25 block45)
	(same-color block34 block22)
	(same-color block34 block25)
	(same-color block34 block42)
	(same-color block34 block45)
	(same-color block42 block22)
	(same-color block42 block25)
	(same-color block42 block34)
	(same-color block42 block45)
	(same-color block45 block22)
	(same-color block45 block25)
	(same-color block45 block34)
	(same-color block45 block42)
	(same-color block12 block14)
	(same-color block12 block32)
	(same-color block12 block43)
	(same-color block12 block47)
	(same-color block14 block12)
	(same-color block14 block32)
	(same-color block14 block43)
	(same-color block14 block47)
	(same-color block32 block12)
	(same-color block32 block14)
	(same-color block32 block43)
	(same-color block32 block47)
	(same-color block43 block12)
	(same-color block43 block14)
	(same-color block43 block32)
	(same-color block43 block47)
	(same-color block47 block12)
	(same-color block47 block14)
	(same-color block47 block32)
	(same-color block47 block43)
	(same-color block24 block33)
	(same-color block24 block36)
	(same-color block24 block44)
	(same-color block33 block24)
	(same-color block33 block36)
	(same-color block33 block44)
	(same-color block36 block24)
	(same-color block36 block33)
	(same-color block36 block44)
	(same-color block44 block24)
	(same-color block44 block33)
	(same-color block44 block36)
	(same-color block37 block46)
	(same-color block46 block37)
	(same-color block15 block35)
	(same-color block35 block15)
	(= (num-steps) 0)
)
(:goal (and
	(is-empty block22)
