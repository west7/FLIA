(define (problem puzznic-6)
(:domain puzznic)
(:objects block0 - immovable-block block1 - immovable-block block2 - immovable-block block3 - immovable-block block4 - immovable-block block5 - immovable-block block6 - immovable-block block7 - immovable-block block8 - immovable-block block9 - movable-block block10 - movable-block block11 - movable-block block12 - movable-block block13 - movable-block block14 - movable-block block15 - immovable-block block16 - immovable-block block17 - movable-block block18 - movable-block block19 - movable-block block20 - movable-block block21 - movable-block block22 - movable-block block23 - immovable-block block24 - immovable-block block25 - movable-block block26 - movable-block block27 - movable-block block28 - movable-block block29 - movable-block block30 - matching-block block31 - immovable-block block32 - immovable-block block33 - movable-block block34 - movable-block block35 - movable-block block36 - movable-block block37 - immovable-block block38 - immovable-block block39 - immovable-block block40 - immovable-block block41 - movable-block block42 - movable-block block43 - movable-block block44 - movable-block block45 - movable-block block46 - matching-block block47 - immovable-block block48 - immovable-block block49 - immovable-block block50 - matching-block block51 - immovable-block block52 - matching-block block53 - immovable-block block54 - immovable-block block55 - immovable-block block56 - immovable-block block57 - immovable-block block58 - immovable-block block59 - immovable-block block60 - immovable-block block61 - immovable-block block62 - immovable-block block63 - immovable-block)
(:init
	(is-immovable block0)
	(right block0 block1)
	(down block0 block8)
	...
	(same-color block30 block50)
	(same-color block50 block30)
	(= (num-steps) 0)
)
(:goal (and
	(is-empty block46)
