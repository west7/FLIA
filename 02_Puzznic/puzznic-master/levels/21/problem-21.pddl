(define (problem puzznic-21)
(:domain puzznic)
(:objects block0 - immovable-block block1 - immovable-block block2 - immovable-block block3 - immovable-block block4 - immovable-block block5 - immovable-block block6 - immovable-block block7 - immovable-block block8 - immovable-block block9 - immovable-block block10 - immovable-block block11 - matching-block block12 - movable-block block13 - movable-block block14 - movable-block block15 - matching-block block16 - movable-block block17 - movable-block block18 - movable-block block19 - immovable-block block20 - immovable-block block21 - matching-block block22 - matching-block block23 - immovable-block block24 - immovable-block block25 - immovable-block block26 - movable-block block27 - movable-block block28 - movable-block block29 - immovable-block block30 - immovable-block block31 - immovable-block block32 - matching-block block33 - movable-block block34 - movable-block block35 - immovable-block block36 - matching-block block37 - matching-block block38 - immovable-block block39 - immovable-block block40 - immovable-block block41 - immovable-block block42 - immovable-block block43 - movable-block block44 - movable-block block45 - matching-block block46 - matching-block block47 - immovable-block block48 - immovable-block block49 - immovable-block block50 - immovable-block block51 - immovable-block block52 - immovable-block block53 - immovable-block block54 - movable-block block55 - immovable-block block56 - immovable-block block57 - immovable-block block58 - immovable-block block59 - immovable-block block60 - immovable-block block61 - immovable-block block62 - immovable-block block63 - immovable-block block64 - matching-block block65 - movable-block block66 - immovable-block block67 - immovable-block block68 - immovable-block block69 - immovable-block block70 - immovable-block block71 - immovable-block block72 - immovable-block block73 - movable-block block74 - matching-block block75 - movable-block block76 - matching-block block77 - immovable-block block78 - immovable-block block79 - immovable-block block80 - immovable-block block81 - immovable-block block82 - matching-block block83 - movable-block block84 - matching-block block85 - immovable-block block86 - matching-block block87 - movable-block block88 - immovable-block block89 - immovable-block block90 - immovable-block block91 - movable-block block92 - matching-block block93 - immovable-block block94 - matching-block block95 - immovable-block block96 - matching-block block97 - movable-block block98 - matching-block block99 - immovable-block block100 - immovable-block block101 - matching-block block102 - matching-block block103 - immovable-block block104 - matching-block block105 - immovable-block block106 - matching-block block107 - matching-block block108 - matching-block block109 - immovable-block block110 - immovable-block block111 - immovable-block block112 - immovable-block block113 - immovable-block block114 - immovable-block block115 - immovable-block block116 - immovable-block block117 - immovable-block block118 - immovable-block block119 - immovable-block)
(:init
	(is-immovable block0)
	(right block0 block1)
	(down block0 block10)
	...
	(same-color block22 block46)
	(same-color block22 block64)
	(same-color block22 block76)
	(same-color block22 block94)
	(same-color block46 block22)
	(same-color block46 block64)
	(same-color block46 block76)
	(same-color block46 block94)
	(same-color block64 block22)
	(same-color block64 block46)
	(same-color block64 block76)
	(same-color block64 block94)
	(same-color block76 block22)
	(same-color block76 block46)
	(same-color block76 block64)
	(same-color block76 block94)
	(same-color block94 block22)
	(same-color block94 block46)
	(same-color block94 block64)
	(same-color block94 block76)
	(same-color block11 block108)
	(same-color block108 block11)
	(same-color block32 block36)
	(same-color block32 block74)
	(same-color block32 block82)
	(same-color block36 block32)
	(same-color block36 block74)
	(same-color block36 block82)
	(same-color block74 block32)
	(same-color block74 block36)
	(same-color block74 block82)
	(same-color block82 block32)
	(same-color block82 block36)
	(same-color block82 block74)
	(same-color block21 block106)
	(same-color block106 block21)
	(same-color block37 block102)
	(same-color block102 block37)
	(same-color block96 block107)
	(same-color block107 block96)
	(same-color block45 block84)
	(same-color block84 block45)
	(same-color block15 block86)
	(same-color block15 block92)
	(same-color block15 block98)
	(same-color block15 block101)
	(same-color block15 block104)
	(same-color block86 block15)
	(same-color block86 block92)
	(same-color block86 block98)
	(same-color block86 block101)
	(same-color block86 block104)
	(same-color block92 block15)
	(same-color block92 block86)
	(same-color block92 block98)
	(same-color block92 block101)
	(same-color block92 block104)
	(same-color block98 block15)
	(same-color block98 block86)
	(same-color block98 block92)
	(same-color block98 block101)
	(same-color block98 block104)
	(same-color block101 block15)
	(same-color block101 block86)
	(same-color block101 block92)
	(same-color block101 block98)
	(same-color block101 block104)
	(same-color block104 block15)
	(same-color block104 block86)
	(same-color block104 block92)
	(same-color block104 block98)
	(same-color block104 block101)
	(= (num-steps) 0)
)
(:goal (and
	(is-empty block22)
