(define (problem puzznic-16)
(:domain puzznic)
(:objects block0 - immovable-block block1 - immovable-block block2 - immovable-block block3 - immovable-block block4 - immovable-block block5 - immovable-block block6 - immovable-block block7 - immovable-block block8 - immovable-block block9 - immovable-block block10 - immovable-block block11 - movable-block block12 - matching-block block13 - movable-block block14 - movable-block block15 - movable-block block16 - movable-block block17 - movable-block block18 - movable-block block19 - immovable-block block20 - immovable-block block21 - immovable-block block22 - matching-block block23 - movable-block block24 - matching-block block25 - movable-block block26 - matching-block block27 - immovable-block block28 - matching-block block29 - immovable-block block30 - immovable-block block31 - movable-block block32 - immovable-block block33 - movable-block block34 - matching-block block35 - movable-block block36 - matching-block block37 - movable-block block38 - matching-block block39 - immovable-block block40 - immovable-block block41 - movable-block block42 - movable-block block43 - movable-block block44 - immovable-block block45 - immovable-block block46 - immovable-block block47 - movable-block block48 - immovable-block block49 - immovable-block block50 - immovable-block block51 - matching-block block52 - matching-block block53 - movable-block block54 - movable-block block55 - movable-block block56 - movable-block block57 - movable-block block58 - movable-block block59 - immovable-block block60 - immovable-block block61 - immovable-block block62 - immovable-block block63 - movable-block block64 - immovable-block block65 - immovable-block block66 - immovable-block block67 - immovable-block block68 - movable-block block69 - immovable-block block70 - immovable-block block71 - movable-block block72 - movable-block block73 - movable-block block74 - movable-block block75 - movable-block block76 - matching-block block77 - movable-block block78 - immovable-block block79 - immovable-block block80 - immovable-block block81 - matching-block block82 - immovable-block block83 - movable-block block84 - immovable-block block85 - immovable-block block86 - immovable-block block87 - immovable-block block88 - movable-block block89 - immovable-block block90 - immovable-block block91 - matching-block block92 - movable-block block93 - movable-block block94 - movable-block block95 - movable-block block96 - movable-block block97 - movable-block block98 - movable-block block99 - immovable-block block100 - immovable-block block101 - matching-block block102 - matching-block block103 - movable-block block104 - matching-block block105 - matching-block block106 - matching-block block107 - matching-block block108 - matching-block block109 - immovable-block block110 - immovable-block block111 - immovable-block block112 - immovable-block block113 - immovable-block block114 - immovable-block block115 - immovable-block block116 - immovable-block block117 - immovable-block block118 - immovable-block block119 - immovable-block)
(:init
	(is-immovable block0)
	(right block0 block1)
	(down block0 block10)
	...
	(same-color block24 block28)
	(same-color block24 block51)
	(same-color block24 block91)
	(same-color block24 block106)
	(same-color block28 block24)
	(same-color block28 block51)
	(same-color block28 block91)
	(same-color block28 block106)
	(same-color block51 block24)
	(same-color block51 block28)
	(same-color block51 block91)
	(same-color block51 block106)
	(same-color block91 block24)
	(same-color block91 block28)
	(same-color block91 block51)
	(same-color block91 block106)
	(same-color block106 block24)
	(same-color block106 block28)
	(same-color block106 block51)
	(same-color block106 block91)
	(same-color block12 block26)
	(same-color block12 block102)
	(same-color block12 block104)
	(same-color block12 block108)
	(same-color block26 block12)
	(same-color block26 block102)
	(same-color block26 block104)
	(same-color block26 block108)
	(same-color block102 block12)
	(same-color block102 block26)
	(same-color block102 block104)
	(same-color block102 block108)
	(same-color block104 block12)
	(same-color block104 block26)
	(same-color block104 block102)
	(same-color block104 block108)
	(same-color block108 block12)
	(same-color block108 block26)
	(same-color block108 block102)
	(same-color block108 block104)
	(same-color block34 block38)
	(same-color block34 block52)
	(same-color block34 block101)
	(same-color block34 block107)
	(same-color block38 block34)
	(same-color block38 block52)
	(same-color block38 block101)
	(same-color block38 block107)
	(same-color block52 block34)
	(same-color block52 block38)
	(same-color block52 block101)
	(same-color block52 block107)
	(same-color block101 block34)
	(same-color block101 block38)
	(same-color block101 block52)
	(same-color block101 block107)
	(same-color block107 block34)
	(same-color block107 block38)
	(same-color block107 block52)
	(same-color block107 block101)
	(same-color block22 block36)
	(same-color block22 block76)
	(same-color block22 block81)
	(same-color block22 block105)
	(same-color block36 block22)
	(same-color block36 block76)
	(same-color block36 block81)
	(same-color block36 block105)
	(same-color block76 block22)
	(same-color block76 block36)
	(same-color block76 block81)
	(same-color block76 block105)
	(same-color block81 block22)
	(same-color block81 block36)
	(same-color block81 block76)
	(same-color block81 block105)
	(same-color block105 block22)
	(same-color block105 block36)
	(same-color block105 block76)
	(same-color block105 block81)
	(= (num-steps) 0)
)
(:goal (and
	(is-empty block24)
