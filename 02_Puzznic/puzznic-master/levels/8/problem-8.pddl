(define (problem puzznic-8)
(:domain puzznic)
(:objects block0 - immovable-block block1 - immovable-block block2 - immovable-block block3 - immovable-block block4 - immovable-block block5 - immovable-block block6 - immovable-block block7 - immovable-block block8 - immovable-block block9 - immovable-block block10 - immovable-block block11 - matching-block block12 - movable-block block13 - immovable-block block14 - immovable-block block15 - immovable-block block16 - movable-block block17 - matching-block block18 - movable-block block19 - immovable-block block20 - immovable-block block21 - matching-block block22 - matching-block block23 - movable-block block24 - immovable-block block25 - movable-block block26 - matching-block block27 - matching-block block28 - matching-block block29 - immovable-block block30 - immovable-block block31 - immovable-block block32 - matching-block block33 - matching-block block34 - movable-block block35 - matching-block block36 - matching-block block37 - immovable-block block38 - immovable-block block39 - immovable-block block40 - immovable-block block41 - immovable-block block42 - immovable-block block43 - matching-block block44 - matching-block block45 - matching-block block46 - immovable-block block47 - immovable-block block48 - immovable-block block49 - immovable-block block50 - immovable-block block51 - immovable-block block52 - immovable-block block53 - immovable-block block54 - immovable-block block55 - immovable-block block56 - immovable-block block57 - immovable-block block58 - immovable-block block59 - immovable-block)
(:init
	(is-immovable block0)
	(right block0 block1)
	(down block0 block10)
	...
	(same-color block21 block26)
	(same-color block21 block32)
	(same-color block21 block35)
	(same-color block26 block21)
	(same-color block26 block32)
	(same-color block26 block35)
	(same-color block32 block21)
	(same-color block32 block26)
	(same-color block32 block35)
	(same-color block35 block21)
	(same-color block35 block26)
	(same-color block35 block32)
	(same-color block27 block33)
	(same-color block27 block36)
	(same-color block27 block44)
	(same-color block33 block27)
	...
	(same-color block44 block27)
	(same-color block44 block33)
	(same-color block44 block36)
	(same-color block17 block28)
	(same-color block28 block17)
	(same-color block11 block22)
	(same-color block11 block43)
	(same-color block11 block45)
	(same-color block22 block11)
	(same-color block22 block43)
	(same-color block22 block45)
	(same-color block43 block11)
	(same-color block43 block22)
	(same-color block43 block45)
	(same-color block45 block11)
	(same-color block45 block22)
	(same-color block45 block43)
	(= (num-steps) 0)
)
(:goal (and
	(is-empty block21)
